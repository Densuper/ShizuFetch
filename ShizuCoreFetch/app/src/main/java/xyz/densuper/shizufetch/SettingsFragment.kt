...
import xyz.densuper.shizufetch.databinding.FragmentSettingsBinding
...
class SettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (bottomNav != null) {
            EdgeToEdgeHelper.bindBottomInsetsToPadding(bottomNav, binding.nestedScrollSettings)
        }
    }
    ...
    private fun setupLinks() {
        binding.btnAbout.setOnClickListener {
            openWebPage("https://ShizuFetch.siwane.xyz")
        }

        binding.btnPrivacy.setOnClickListener {
            openWebPage("https://ShizuFetch.siwane.xyz/privacy")
        }

        binding.btnTerms.setOnClickListener {
            openWebPage("https://ShizuFetch.siwane.xyz/terms")
        }
    }
